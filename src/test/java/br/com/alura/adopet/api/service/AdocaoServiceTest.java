...
class AdocaoServiceTest {
    ...
    void deveSalvarAdocao(){

        //ARRANGE
        this.dto = new SolicitacaoAdocaoDto(18l, 23l, "motivo qualquer");
    ...
    @Test
    @DisplayName("Deve verificar se o foreach de validações está sendo percorrido")
    void verificaForeach(){
        //ARRANGE
